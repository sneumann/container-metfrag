...
# install MetFrag
RUN cd /usr/src; wget -O MetFrag.tgz http://msbi.ipb-halle.de/~cruttkie/92f73acb731145c73ffa3dfb8fd59581bee0d844963889338c3ec173874b5a5f/MetFrag.tgz
RUN cd /usr/src; tar -xzf MetFrag.tgz; cd MetFrag; mvn clean install -pl MetFragLib -am -DskipTests
